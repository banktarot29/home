...
- omen คือภาพรวมฮวงจุ้ยบ้านหลังนี้ 3-5 ประโยค เริ่มจากผลที่สะท้อนออกมาในชีวิตก่อน ห้ามเริ่มด้วยคำว่าฮวงจุ้ย เช่น บ้านหลังนี้มีพื้นฐานที่ดี แต่มีบางจุดที่ทำให้พลังงานเข้าแล้วกระจายตัวไม่เต็มที่...
- typeCheck บอกว่าภาพสอดคล้องกับรูปแบบที่ผู้ใช้เลือกหรือไม่ ถ้าไม่แน่ใจให้บอกตรงๆ
- frontPart 3-5 ประโยค เจาะจากภาพหน้าบ้านจริง ต้องพูดถึงสิ่งที่เห็น เช่น ทางเข้า ประตู รั้ว ทางลาด พื้น ชาน ของวาง ตู้ไฟ สายไฟ หลังคา ความโปร่งหรือทึบ
- interiorPart ถ้ามีภาพภายใน ให้แยกวิเคราะห์ภาพรวมภายใน ถ้าไม่มี ให้บอกว่ายังไม่เห็นโถงแรก ห้องนั่งเล่น ทางเดินหลัก และระบุสั้นๆ ว่าควรถ่ายเพิ่มจากจุดไหน เช่น ยืนหลังประตูหลักหันกล้องเข้าบ้านให้เห็นทางเดินและพื้นที่รับแขก เพราะข้อมูลนี้อาจเปลี่ยนลำดับจุดที่ควรแก้
- observationsText ใส่ 5-6 ข้อ คั่นด้วย | แต่ละข้อให้เป็น หัวข้อสั้น: รายละเอียด แต่ไม่ใช่เช็กลิสต์ลอยๆ ให้ตอบว่าบ้านกำลังบอกอะไรกับเจ้าของ และอาการที่มักพบร่วมกับบ้านลักษณะนี้ ใช้คำว่า มักพบร่วมกับ ห้ามสรุปว่าเป็นแน่นอน

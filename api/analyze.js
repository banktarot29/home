...
- frontPart ต้องเป็นบทวิเคราะห์ 3-5 ประโยค ห้ามตอบสั้น ๆ แค่ "หน้าบ้าน" หรือ "ภาพรวม" ต้องพูดถึงประตูหลัก ทางเดิน รั้ว พื้น แสง และสิ่งที่เห็นจริงจากภาพ
...
- ห้ามใช้คำว่า AI ในคำตอบ
- ถ้าต้องตรวจเพิ่ม ให้เขียนเฉพาะจุด เช่น "ควรดูระดับพื้นจริงเทียบกับถนนและแนวทางเดิน" ห้ามใช้ข้อความซ้ำกันทุกข้อ
- ห้ามใช้คำว่า "จุดนี้ให้ซินแสดูหน้างานเพื่อเช็กของจริงได้" ซ้ำเป็น hint ทุกข้อ ให้เขียนเหตุผลเฉพาะของแต่ละหัวข้อ
